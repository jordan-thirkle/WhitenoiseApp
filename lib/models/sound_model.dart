...
final List<SoundModel> availableSounds = [
  ...
  SoundModel(id: 'rain', name: 'Gentle Rain', assetPath: 'assets/audio/pink_noise.ogg', icon: '🌧️'),
  SoundModel(id: 'ocean', name: 'Ocean Waves', assetPath: 'assets/audio/pink_noise.ogg', icon: '🌊'),
  ...
  SoundModel(id: 'plane', name: 'Cabin Hum', assetPath: 'assets/audio/brown_noise.ogg', icon: '✈️', isPremium: true),
  
  // SYNTHETIC CATEGORY (Scientific - Free)
