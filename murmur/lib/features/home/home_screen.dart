      ...
      child: AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            ListTile(
              title: const Text('Connect to Apple Health'),
              subtitle: const Text('Sync sleep duration to help track your rest goals.', style: TextStyle(fontSize: 10, color: Colors.white30)),
              trailing: const Icon(Icons.favorite_rounded, color: Colors.pinkAccent, size: 18),
              onTap: () {
                ref.read(healthServiceProvider).openHealthDashboard();
                Navigator.pop(context);
              },
